...
= 0.9.12 =
Honest bugfix release. Fixes visual regressions and update loop issues introduced in v0.9.10.

== Changelog ==

= 0.9.12 =
* **Fix**: Synchronized documentation and internal changelogs.
* **Maintenance**: Code cleanup for production readiness.

= 0.9.11 =
* **Fix**: Resolved "Infinite Update Loop" caused by version mismatch in plugin headers.
* **Fix**: Corrected "Giant Icon" bug in admin menu that obscured other WordPress menus. Reverted sidebar to Dashicons for stability.
* **Enhancement**: Added SVG branding to the update flow and plugin list details.

= 0.9.10 =
* **Feature**: Official Visual Identity. Added SVG Logo integration.
* **Feature**: Branding support for the Millaredos Official Landing Page.
