...
class Millaredos_GDPR_Comments_Admin {
	...
	public function add_plugin_list_icon() {
		...
		<style>
			...
			/* Menu Icon Filter to match sidebar white/gray */
			.toplevel_page_millaredos-gdpr-comments .wp-menu-image img {
				padding: 4px 0 !important;
				filter: brightness(0) invert(1) opacity(0.7);
			}
			.toplevel_page_millaredos-gdpr-comments:hover .wp-menu-image img,
			.toplevel_page_millaredos-gdpr-comments.wp-has-current-submenu .wp-menu-image img {
